...
var AboutComponent = /** @class */ (function () {
    ...
    AboutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["trigger"])('fadeInUp', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])('* => *', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["useAnimation"])(ng_animate__WEBPACK_IMPORTED_MODULE_3__["fadeInUp"]))])
            ],
...
/* harmony import */ var _blog_single_blog_single_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./blog-single/blog-single.component */ "./src/app/blog-single/blog-single.component.ts");
...
/* harmony import */ var _contact_shared_contact_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./contact/shared/contact.service */ "./src/app/contact/shared/contact.service.ts");
...
/* harmony import */ var ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ng2-animate-on-scroll */ "./node_modules/ng2-animate-on-scroll/dist/index.js");
/* harmony import */ var ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_23__);
...
/* harmony import */ var _core_auth_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./core/auth.service */ "./src/app/core/auth.service.ts");
/* harmony import */ var _core_user_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./core/user.service */ "./src/app/core/user.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _blog_single_blog_single_component__WEBPACK_IMPORTED_MODULE_11__["BlogSingleComponent"],
            ...
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_17__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_21__["environment"].firebase),
                angularfire2_database__WEBPACK_IMPORTED_MODULE_18__["AngularFireDatabaseModule"],
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_22__["BrowserAnimationsModule"],
                ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_23__["AnimateOnScrollModule"].forRoot(),
                _angular_forms__WEBPACK_IMPORTED_MODULE_15__["FormsModule"],
                angularfire2_auth__WEBPACK_IMPORTED_MODULE_19__["AngularFireAuthModule"],
                angularfire2_firestore__WEBPACK_IMPORTED_MODULE_20__["AngularFirestoreModule"] // for database
            ],
            providers: [_contact_shared_contact_service__WEBPACK_IMPORTED_MODULE_16__["ContactService"], _core_auth_service__WEBPACK_IMPORTED_MODULE_28__["AuthService"], _core_user_service__WEBPACK_IMPORTED_MODULE_29__["UserService"], _core_auth_guard__WEBPACK_IMPORTED_MODULE_30__["AuthGuard"]],
...
/***/ "./src/app/blog-single/blog-single.component.css":
/*!*******************************************************!*\
  !*** ./src/app/blog-single/blog-single.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Jsb2ctc2luZ2xlL2Jsb2ctc2luZ2xlLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/blog-single/blog-single.component.html":
/*!********************************************************!*\
  !*** ./src/app/blog-single/blog-single.component.html ***!
  \********************************************************/
/*! no static exports found */
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_blog_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/blog.service */ "./src/app/blog-single/shared/blog.service.ts");
...
var BlogSingleComponent = /** @class */ (function () {
    function BlogSingleComponent(blogService, afAuth) {
        this.blogService = blogService;
        this.afAuth = afAuth;
        this.formControls = this.blogService.form.controls;
        this.formControls1 = this.blogService.form1.controls;
        this.commentArray = [];
        this.replyArray = [];
        this.replyIsOn = false;
        this.togglePanel = {};
        this.togglePanel1 = {};
        this.show = false;
        this.register = false;
    ...
    BlogSingleComponent.prototype.onSubmit = function () {
        var _this = this;
        this.submitted = true;
        if (this.blogService.form.valid) {
            if (this.blogService.form.get('$key').value == null) {
                this.blogService.insertComment(this.blogService.form.value);
                this.blogService.form.reset();
    ...
    BlogSingleComponent.prototype.isLoggedIn = function () {
        return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise();
    };
    BlogSingleComponent.prototype.toggle = function () {
        this.show = !this.show;
    };
    BlogSingleComponent.prototype.registerToggle = function () {
        this.register = !this.register;
    };
    BlogSingleComponent.prototype.onReply = function () {
        var _this = this;
        var commentElement = document.createElement('div');
        this.replySubmitted = true;
        if (this.blogService.form1.valid) {
            if (this.blogService.form1.get('$key').value == null) {
                this.blogService.insertReply(this.blogService.form1.value);
                this.para1.nativeElement.appendChild(commentElement);
                this.blogService.form1.reset();
                this.replySubmittedSuccessfully = true;
                setTimeout(function () {
                    _this.replySubmittedSuccessfully = false;
                }, 3000);
            }
    ...
    BlogSingleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.blogService.getComments().subscribe(function (list) {
            _this.commentArray = list.map(function (item) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ $key: item.key }, item.payload.val());
            });
        });
        this.blogService.getReplies().subscribe(function (list) {
            _this.replyArray = list.map(function (item) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ $key: item.key }, item.payload.val());
            });
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('para1'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], BlogSingleComponent.prototype, "para1", void 0);
    BlogSingleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-blog-single',
            template: __webpack_require__(/*! ./blog-single.component.html */ "./src/app/blog-single/blog-single.component.html"),
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_5__["trigger"])('fadeInUp', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_5__["transition"])('* => *', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_5__["useAnimation"])(ng_animate__WEBPACK_IMPORTED_MODULE_6__["fadeInUp"]))])
            ],
            styles: [__webpack_require__(/*! ./blog-single.component.css */ "./src/app/blog-single/blog-single.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"], angularfire2_auth__WEBPACK_IMPORTED_MODULE_4__["AngularFireAuth"]])
    ], BlogSingleComponent);
...
/***/ "./src/app/blog-single/shared/blog.service.ts":
/*!****************************************************!*\
  !*** ./src/app/blog-single/shared/blog.service.ts ***!
  \****************************************************/
...
var BlogService = /** @class */ (function () {
    function BlogService(firebase) {
        ...
        this.form1 = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            $key: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](null),
            fullname1: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
            email1: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].email]),
            website1: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](''),
            message1: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required)
        });
    }
    BlogService.prototype.getComments = function () {
        console.log('get comments');
        this.comments = this.firebase.list('comments');
        return this.comments.snapshotChanges();
    };
    BlogService.prototype.getReplies = function () {
        this.replies = this.firebase.list('replies');
        return this.replies.snapshotChanges();
    };
    BlogService.prototype.insertComment = function (comment) {
        this.comments.push({
    ...
    BlogService.prototype.insertReply = function (reply) {
        this.replies.push({
            fullname: reply.fullname1,
            email: reply.email1,
            website: reply.website1,
...
module.exports = "<app-navbar></app-navbar>\n<section class=\"hero-wrap js-fullheight\" style=\"background-image: url('assets/images/bg_3.jpg');\">\n  <div class=\"overlay\"></div>\n  <div class=\"container\">\n    <div class=\"row no-gutters slider-text js-fullheight align-items-center justify-content-center\">\n      <div class=\"col-md-9 text-center\">\n        <h1 class=\"mb-3 bread\" [@fadeInUp]=\"fadeInUp\">Our Blog</h1>\n        <p class=\"breadcrumbs\"><span class=\"mr-2\"><a href=\"index.html\">Home</a></span> <span>Blog</span></p>\n      </div>\n    </div>\n  </div>\n</section>\n<section class=\"ftco-section bg-light\">\n  <div class=\"container\">\n    <div class=\"row d-flex\">\n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry justify-content-end\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_1.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">31</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry justify-content-end\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_2.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">27</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_3.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">25</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n      \n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry justify-content-end\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_4.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">31</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry justify-content-end\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_5.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">27</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-md-4 d-flex\">\n        <div class=\"blog-entry\">\n          <a routerLink=\"/blog-single\" class=\"block-20\" style=\"background-image: url('assets/images/image_6.jpg');\">\n          </a>\n          <div class=\"text p-4 float-right d-block\">\n            <div class=\"d-flex align-items-center pt-2 mb-4\">\n              <div class=\"one\">\n                <span class=\"day\">25</span>\n              </div>\n              <div class=\"two\">\n                <span class=\"yr\">2018</span>\n                <span class=\"mos\">December</span>\n              </div>\n            </div>\n            <h3 class=\"heading mt-2\"><a href=\"#\">Young Women Doing Yoga</a></h3>\n            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"row mt-5\">\n      <div class=\"col text-center\">\n        <div class=\"block-27\">\n          <ul>\n            <li><a href=\"#\">&lt;</a></li>\n            <li class=\"active\"><span>1</span></li>\n            <li><a href=\"#\">2</a></li>\n            <li><a href=\"#\">3</a></li>\n            <li><a href=\"#\">4</a></li>\n            <li><a href=\"#\">5</a></li>\n            <li><a href=\"#\">&gt;</a></li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n<app-footer></app-footer>\n\n"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NsYXNzZXMvY2xhc3Nlcy5jb21wb25lbnQuY3NzIn0= */"
...
module.exports = "<app-navbar></app-navbar>\n<section class=\"hero-wrap js-fullheight\" style=\"background-image: url('assets/images/bg_3.jpg');\">\n    <div class=\"overlay\"></div>\n    <div class=\"container\">\n      <div class=\"row no-gutters slider-text js-fullheight align-items-center justify-content-center\">\n        <div class=\"col-md-9 text-center\">\n          <h1 class=\"mb-3 bread\" [@fadeInUp]=\"fadeInUp\">Yoga Classes</h1>\n          <p class=\"breadcrumbs\"><span class=\"mr-2\"><a href=\"index.html\">Home</a></span> <span>Classes</span></p>\n        </div>\n      </div>\n    </div>\n  </section>\n      \n\n    <section class=\"ftco-section\">\n        <div class=\"container\">\n            <div class=\"row justify-content-center mb-5 pb-3\">\n        <div class=\"col-md-12 heading-section text-center\">\n          <h3 class=\"subheading\">Yoga Classes</h3>\n          <h2 class=\"mb-1\">Choose Your Level &amp; Focus</h2>\n        </div>\n      </div>\n      <div class=\"row no-gutters\">\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-1.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Group Lessons</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-2.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Yoga For Beginners</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-3.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Yoga For Pregnant</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-4.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Yoga For Couples</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-5.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Bikram Yoga</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n          <div class=\"col-md-6 col-lg-4\">\n              <div class=\"package-program\">\n                  <a href=\"#\" class=\"img d-flex justify-content-center align-items-center\" style=\"background-image: url(assets/images/program-6.jpg);\">\n                      <div class=\"text p-5 text-center\">\n                          <h3>Yoga Barre</h3>\n                          <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>\n                      </div>\n                  </a>\n              </div>\n          </div>\n      </div>\n        </div>\n    </section>\n\n\n  \n      <section class=\"ftco-gallery ftco-section\">\n      <div class=\"container\">\n          <div class=\"row justify-content-center mb-5 pb-3\">\n        <div class=\"col-md-7 heading-section text-center\">\n          <h3 class=\"subheading\">Gallery</h3>\n          <h2 class=\"mb-1\">See the latest photos</h2>\n        </div>\n      </div>\n          <div class=\"row\">\n                  <div class=\"col-md-3\">\n                      <a href=\"assets/images/gallery-1.jpg\" class=\"gallery image-popup img d-flex align-items-center\" style=\"background-image: url(assets/images/gallery-1.jpg);\">\n                          <div class=\"icon mb-4 d-flex align-items-center justify-content-center\">\n                          <span class=\"icon-instagram\"></span>\n                      </div>\n                      </a>\n                  </div>\n                  <div class=\"col-md-3\">\n                      <a href=\"assets/images/gallery-2.jpg\" class=\"gallery image-popup img d-flex align-items-center\" style=\"background-image: url(assets/images/gallery-2.jpg);\">\n                          <div class=\"icon mb-4 d-flex align-items-center justify-content-center\">\n                          <span class=\"icon-instagram\"></span>\n                      </div>\n                      </a>\n                  </div>\n                  <div class=\"col-md-3\">\n                      <a href=\"assets/images/gallery-3.jpg\" class=\"gallery image-popup img d-flex align-items-center\" style=\"background-image: url(assets/images/gallery-3.jpg);\">\n                          <div class=\"icon mb-4 d-flex align-items-center justify-content-center\">\n                          <span class=\"icon-instagram\"></span>\n                      </div>\n                      </a>\n                  </div>\n                  <div class=\"col-md-3\">\n                      <a href=\"assets/images/gallery-4.jpg\" class=\"gallery image-popup img d-flex align-items-center\" style=\"background-image: url(assets/images/gallery-4.jpg);\">\n                          <div class=\"icon mb-4 d-flex align-items-center justify-content-center\">\n                          <span class=\"icon-instagram\"></span>\n                      </div>\n                      </a>\n                  </div>\n      </div>\n      </div>\n  </section>\n  <app-footer></app-footer>"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_contact_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/contact.service */ "./src/app/contact/shared/contact.service.ts");
/* harmony import */ var _angular_animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/animations */ "./node_modules/@angular/animations/fesm5/animations.js");
/* harmony import */ var ng_animate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-animate */ "./node_modules/ng-animate/fesm5/ng-animate.js");
...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.onSubmit = function () {
        var _this = this;
        this.submitted = true; // on submission set this to true
    ...
    ContactComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["trigger"])('fadeInUp', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["transition"])('* => *', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["useAnimation"])(ng_animate__WEBPACK_IMPORTED_MODULE_4__["fadeInUp"]))])
            ],
...
var ContactService = /** @class */ (function () {
    function ContactService(firebase) {
        this.firebase = firebase;
        /**  declare var of FormGroup instance and
         in that create an object containing properties of customers
        */
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _typewriter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../typewriter */ "./src/app/typewriter.ts");
/* harmony import */ var _angular_animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/animations */ "./node_modules/@angular/animations/fesm5/animations.js");
/* harmony import */ var ng_animate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-animate */ "./node_modules/ng-animate/fesm5/ng-animate.js");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent() {
        ...
        this.typewriter = new _typewriter__WEBPACK_IMPORTED_MODULE_2__["TypeWriter"](this.txtElement, this.words, this.wait);
    }
    HomeComponent.prototype.init = function () {
        ...
        // Init TypeWriter
        new _typewriter__WEBPACK_IMPORTED_MODULE_2__["TypeWriter"](txtElement, words, wait);
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.tryLogin = function (value) {
        ...
        this.authService.doLogin(value)
            .then(function (res) {
            _this.router.navigate(['/blog-single']);
...
module.exports = ".header {\n  text-align: center;\n  font-size: 30px;\n  margin-bottom: 40px; }\n\n.row {\n  margin-top: 10px; }\n\n.error {\n  color: red; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".header {\n  text-align: center;\n  font-size: 30px;\n  margin-bottom: 40px; }\n\n.row {\n  margin-top: 10px; }\n\n.error {\n  color: red; }\n\n.success {\n  color: green; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _classes_classes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/classes.component */ "./src/app/classes/classes.component.ts");
/* harmony import */ var _blog_single_blog_single_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blog-single/blog-single.component */ "./src/app/blog-single/blog-single.component.ts");
...
/* harmony import */ var _core_auth_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./core/auth.guard */ "./src/app/core/auth.guard.ts");
...
var appRoutes = [
    ...
    { path: 'classes', component: _classes_classes_component__WEBPACK_IMPORTED_MODULE_2__["ClassesComponent"] },
    { path: 'blog-single', component: _blog_single_blog_single_component__WEBPACK_IMPORTED_MODULE_3__["BlogSingleComponent"] },
    ...
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"], canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'register', component: _register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"], canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
...
var TypeWriter = /** @class */ (function () {
    function TypeWriter(txtElement, words, wait) {
        ...
        this.words = ['Inspiration For Joyful Living.', 'Effective Therapy Against Stress.', 'Flexibility is A Second Power.'];
        this.txt = '';
        this.wordIndex = 0;
...
module.exports = ".image {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCpl_FPewXu-LrM0gtpNDaMY7_thVbw4Vc",
        authDomain: "registrationform-1899e.firebaseapp.com",
        databaseURL: "https://registrationform-1899e.firebaseio.com",
        projectId: "registrationform-1899e",
        storageBucket: "registrationform-1899e.appspot.com",
        messagingSenderId: "634436226986"
    }
};
/*
...
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/yogaAngular/yoga/src/main.ts */"./src/main.ts");
